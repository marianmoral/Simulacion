...
if LINLIN:
    pl.gcf().savefig("model_fit_figures/modelo_mompleto_todas_prov_lineal.png",dpi=300)
else:
    pl.gcf().savefig("model_fit_figures/modelo_mompleto_todas_prov_log.png",dpi=300)
